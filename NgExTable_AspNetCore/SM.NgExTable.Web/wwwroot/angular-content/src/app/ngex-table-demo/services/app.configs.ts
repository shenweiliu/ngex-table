...
export const WebApiRootUrl: string = "https://StoreDataServiceApi/api/";
...
export const TableConfig: any = {    
    ...
    //paginationMaxBlocks: 3, /* number: maximum number of page number buttons if '...' shown on both sides */
...
import { IMyDatePickerOptions, IMyMarkedDate } from
    //'../../ngex-mydatepicker/export.module'; //local
    'ngex-mydatepicker'; //lib
export const MyDatePickConfig: IMyDatePickerOptions = {
    ...
    selectorWidth: '15rem', //'250px',
    closeSelectorOnDateSelect: true,
    closeSelectorOnDocumentClick: true,
    appendSelectorToBody: true,
    stylesData: {        
        styles: `.myDpIconLeftArrow, 
                 .myDpIconRightArrow {
                    font-size: 0.9rem;
                }  
             `
