...
export interface UseAbsoluteTemplateUrl {
    PaginationComponent: boolean;
    ColumnSortingComponent: boolean;
    MultiSortingCommandComponent: boolean;
    OptionsComponent: boolean;
    SortingTypeComponent: boolean;
}
